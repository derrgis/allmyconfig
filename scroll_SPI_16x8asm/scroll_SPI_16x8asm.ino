...
#define __TIMER1_CNT 0x100// 32 levels --> 0x0130; 38 --> 0x0157 (flicker)
#include <io.h>
#include <interrupt.h>
...
uint32_t tab[8]={B11111111,B00000000,B11110000,B00001111,B11100011,B1110000,B00000011,B11011100};
short int tab2[8]={B11111111,B00000000,B11110000,B00001111,B11100011,B1110000,B00000011,B11011100};
...
void scrolllettre(int let,uint32_t coul,int ligne)
{
  
  for (int g=0;g<taille[let];g++)
  {
    for (int i=0+ligne;i<=4+ligne;i++)
    {
...
void loop() {
  ...
  char mess[]="HAPPY BIRTHDAY ARINA FROM YVES WITH LOVE AND KISSES ....  ";
