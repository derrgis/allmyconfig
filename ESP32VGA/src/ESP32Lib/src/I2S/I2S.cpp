...
Serial.println("in d4");
	...
	i2s.sample_rate_conf.val = 0;
    i2s.sample_rate_conf.tx_bits_mod =16;//32; //16
 Serial.println("in d5");
   ...
   // rtc_clk_apll_enable(true, 1, 0,0 , 0);
    ...
    i2s.clkm_conf.clkm_div_num =1;//33;//33;//1; //clockN;
    i2s.clkm_conf.clkm_div_a = 1 ; //3   //clockA;
    i2s.clkm_conf.clkm_div_b =0;  //1 //clockB;
