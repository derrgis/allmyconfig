...
//NeoPixelBus<NeoGrbFeature, NeoEsp32I2sMethodBase> strip(PixelPin,PixelCount, (size_t)3);
NeoPixelBus<NeoRgbFeature, NeoEsp32I2s1Ws2812xMethod> strip(PixelCount, PixelPin);
...
void setup()
{
    ...
    strip.SetPixelColor(5, RgbColor(23,78,255));
